...
En este ejemplo tenemos 4 tipos de dialogos:
...
4. Mostraremos un dialogo de espera. Sirve para decir al usuario que se
esta procesando algún dato.
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bDialogoEnProceso.setOnClickListener(view -> {
            ...
            // Usamos un Handler para evitar bloquear el hilo principal
            //y simular un retarde de 5 segundos
